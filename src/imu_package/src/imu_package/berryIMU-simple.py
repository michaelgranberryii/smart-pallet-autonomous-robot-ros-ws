...
while True:
    ...
    if 1:                       #Change to '0' to stop  showing the angles from the gyro
        outputString +="\t# GYR_X Angle %5.2f  GYR_Y Angle %5.2f  GYR_Z Angle %5.2f # " % (gyroXangle,gyroYangle,gyroZangle)

    if 1:                       #Change to '0' to stop  showing the angles from the complementary filter
        outputString +="\t#  CFangle_X Angle %5.2f   CFangle_Y Angle %5.2f  #" % (CFangleX,CFangleY)
